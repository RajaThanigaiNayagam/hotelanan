...
if (strlen($_SESSION['hotelanan']==0)) {
   header('location:logout.php');
 	...
 	if(isset($_POST['submit']))
  	{
		$hbmsaid=$_SESSION['hotelanan'];
		$pagetitle=$_POST['pagetitle'];
		$pagedes=$_POST['pagedes'];
		$sql="update pageutil set PageTitle=:pagetitle,PageDescription=:pagedes where  PageType='aboutus'";
	...
	<html>
		<head>
			<title>Hotel ANAN - Systéme de réservation | À propos de nous</title>
