...
if (strlen($_SESSION['hotelanan']==0)) {
	...
	<html>
		<head>
			<title>Hôtel ANAN - Systéme de réservation | Réservation approuvée</title>
													...
													<div class="form-body">
														<table class="table table-bordered table-striped table-vcenter js-dataTable-full-pagination">
															...
															<tbody>
																...
																$sql="SELECT user.*,booking.BookingNumber,booking.Status,booking.BookingDate from booking join user on booking.UserID=user.ID where booking.Status='approuvée' LIMIT $offset, $no_of_records_per_page";
																...
																if($query->rowCount() > 0)
																{
																	...
																	{               ?>
																		<tr>
																			...
																			<?php if($row->Status==""){ ?>
																				<td class="font-w600"><?php echo "Aucune réservation n'a pas encore été mise a jour"; ?></td>
																			<?php } else { ?>
																				<td class="d-none d-sm-table-cell">
