										...
										<div class="forms">
											<div class="form-grids widget-shadow" data-example-id="basic-forms"> 
												...
												<div class="form-body">
													...
													$tdate=$_POST['todate'];
													?>
													<h4 align="center" style="color:blue">Rapport de <?php echo $fdate?> au <?php echo $tdate?></h4>
													<table class="table table-bordered table-striped table-vcenter js-dataTable-full-pagination">
														...
														<tbody>
															...
															$sql="SELECT user.*,booking.BookingNumber,booking.ID,booking.Status,booking.BookingDate from booking join user on booking.UserID=user.ID where date(BookingDate) between '$fdate' and '$tdate' LIMIT $offset, $no_of_records_per_page";
																...
																{               ?>
																	<tr>
																		...
																		<td class="d-none d-sm-table-cell">
																			<span class="badge rounded-pill bg-success"><?php  echo htmlentities($row->BookingDate);?></span>
																		</td>
																		<?php if($row->Status==""){ ?>
																			<td class="font-w600"><?php echo "Not Updated Yet"; ?></td>
																		<?php } else { ?>
																			<td class="d-none d-sm-table-cell"><span class="badge rounded-pill bg-success"><?php  echo htmlentities($row->Status);?></span></td>
																		<?php } ?> 
