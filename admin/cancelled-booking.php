...
if (strlen($_SESSION['hotelanan']==0)) {
	...
	<html>
		<head>
			<title>Hotel ANAN - Systéme de réservation | Réservation annulée</title>
												...
												<div class="form-body">
													<table class="table table-bordered table-striped table-vcenter js-dataTable-full-pagination">
														...
														<tbody>
															...
															$sql="SELECT user.*,booking.BookingNumber,booking.Status,booking.BookingDate from booking join user on booking.UserID=user.ID where booking.Status='annulée' LIMIT $offset, $no_of_records_per_page";
															...
															if($query->rowCount() > 0)
															{
																...
																<tr>
																	<td colspan="8" style="color:red; font-size:22px; text-align:center">Aucune réservation trouvée</td>
																</tr>
															<?php } ?>
														</tbody>
													</table>
