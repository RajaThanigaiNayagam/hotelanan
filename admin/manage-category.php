...
if (strlen($_SESSION['hotelanan']==0)) {
  header('location:logout.php');
	...
	if(isset($_GET['delid']))
	{
		...
		$sql="delete from roomcategory where ID=:rid";
	...
	<html>
		<head>
			<title>Hotel ANAN - Systéme de réservation | Ajouter une catégorie de chambre</title>
													...
													<table class="table table-bordered table-striped table-vcenter js-dataTable-full-pagination">
														<thead>
															<tr>
																...
																<th class="d-none d-sm-table-cell">Description de la catégorie</th>
														...
														<tbody>
															...
															$ret = "SELECT ID FROM roomcategory";
															...
															$sql="SELECT * from roomcategory LIMIT $offset, $no_of_records_per_page";
															$query = $dbh -> prepare($sql);
															$query->execute();
																...
																{               ?>
																	<tr>
																		...
																		<td class="d-none d-sm-table-cell">
																			<span class="badge rounded-pill bg-success"><?php  echo htmlentities($row->Date);?></span>
																		</td>
																		<td class="d-none d-sm-table-cell"><a href="manage-category.php?delid=<?php echo ($row->ID);?>" onclick="return confirm('Voulez-vous vraiment supprimer ?');">Supprimer</a></td>
																	</tr>
																	<?php $cnt=$cnt+1;
																}
															} ?> 
