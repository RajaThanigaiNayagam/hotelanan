...
if (strlen($_SESSION['hotelanan']==0)) {
	...
	<html>
		<head>
			<title>Hotel ANAN - Systéme de réservation | Nouvelle réservation</title>
												...
												<div class="form-body">
													<table class="table table-bordered table-striped table-vcenter js-dataTable-full-pagination">
														...
														<tbody>
															...
															$sql="SELECT user.*,booking.BookingNumber,booking.Status,booking.BookingDate from booking join user on booking.UserID=user.ID where booking.Status is null LIMIT $offset, $no_of_records_per_page";
