...
if (strlen($_SESSION['hotelanan']==0)) {
   header('location:logout.php');
	...
	<html>
		<head>
			<title>Hotel ANAN - Systéme de réservation | Lire les messages</title>
													...
													<table class="table table-bordered table-striped table-vcenter js-dataTable-full-pagination">
														<thead>
															<tr>
																...
																<th class="d-none d-sm-table-cell">Date du message</th>
																<th class="d-none d-sm-table-cell" style="width: 15%;">Afficher le détail</th>
															</tr>
														</thead>
														<tbody>
															<?php
															...
															$sql="SELECT * from contact where IsRead='1' LIMIT $offset, $no_of_records_per_page";
																...
																{               ?>
																	<tr>
																		...
																		<td class="d-none d-sm-table-cell">
																			<span class="badge rounded-pill bg-success"><?php  echo htmlentities($row->EnquiryDate);?></span>
																		</td>
