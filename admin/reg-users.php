...
if (strlen($_SESSION['hotelanan']==0)) {
	...
	<html>
		<head>
			<title>Hotel ANAN - Systéme de réservation | Utilisateur enregistré</title>
													...
													<table class="table table-bordered table-striped table-vcenter js-dataTable-full-pagination">
														<thead>
															<tr>
																...
																<th>nom</th>
																<th class="d-none d-sm-table-cell">Numéro de mobile</th>
																<th class="d-none d-sm-table-cell">Address mail</th>
																...
																{               ?>
																	<tr>
																		...
																		<td class="d-none d-sm-table-cell">
																			<span class="badge rounded-pill bg-success"><?php  echo htmlentities($row->RegDate);?></span>
																		</td>
																	</tr>
																	<?php $cnt=$cnt+1;
																}
