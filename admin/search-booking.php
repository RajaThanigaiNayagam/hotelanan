...
if (strlen($_SESSION['hotelanan']==0)) {
   header('location:logout.php');
	...
	<html>
		<head>
			<title>Hotel ANAN - Systéme de réservation | Rechercher une réservation</title>
										...
										<div class="forms">
											<div class="form-grids widget-shadow" data-example-id="basic-forms"> 
												<div class="form-title">
													<h4>Rechercher une réservation</h4>
												</div>
												<form id="basic-form" method="post">
													<div class="form-group" style="padding-top: 20px">
														<label style="font-size: 20px;padding-bottom: 10px">Rechercher une réservation</label>
														<input id="searchdata" type="text" name="searchdata" required="true" class="form-control" placeholder="Entrez votre numéro de réservation">
													</div><br>
												...
												<div class="form-body">
													...
													{ 
														...
														<h4 align="center">Résultat par rapport au mot-clé du numéro de réservation - "<?php echo $sdata;?>"</h4>
