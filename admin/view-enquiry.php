...
if (strlen($_SESSION['hotelanan']==0)) {
	...
	<html>
		<head>
			<title>Hôtel ANAN - Systéme de réservation | Afficher les messages</title>
														...
														if($query->rowCount() > 0)
														{
															...
															{               ?>				
																<table border="1" class="table table-bordered">
																	<tr align="center">
																	<td colspan="4" style="font-size:20px;color:blue">Détails de l'utilisateur</td></tr>
																		<tr>
																		<th scope>Nom</th>
																		<td><?php  echo ($row->Name);?></td>
																		<th scope>Numéro de portable</th>
